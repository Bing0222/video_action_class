...
class Dataset_3DCNN(data.Dataset):
    ...
    def read_image(self,path,selected_folder,use_transform):
        X = []
    ...
    def __getitem__(self, index):
        ...
        # load data
        X = self.read_image(self.data_path,folder,self.transform).unsqueeze_(0)
...
class CNN3D(nn.Module):
    def __init__(self,t_dim=120,img_x=90,img_y=120,
                 drop_p=0.2,fc_hidden1=256,fc_hidden2=128,
                 num_classes=50):
        ...
        self.conv1_outshape = conv3D_output_size((self.t_dim, self.img_x,self.img_y),
                                                 self.pd1,self.k1,self.s1)
        self.conv2_outshape = conv3D_output_size(self.conv1_outshape, 
                                                 self.pd2, self.k2, self.s2)
        self.conv1 = nn.Conv3d(in_channels=1,out_channels=self.ch1, 
...
class EncoderCNN(nn.Module):
    def __init__(self, img_x=90, img_y=120, 
